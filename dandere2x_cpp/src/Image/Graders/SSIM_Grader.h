...
#ifndef DANDERE2X_CPP_SSIM_GRADER_H
#define DANDERE2X_CPP_SSIM_GRADER_H

#include <Image/SSIM/SSIM-MSE.h>
#include "AbstractMetric.h"


class SSIM_Grader : AbstractGrader {

public:
    SSIM_Grader(std::shared_ptr<Image> image1,
    ...
    bool passes_metric(int initial_x, int initial_y, int variable_x, int variable_y, int blocksize) override {
        ...
        double image_2_image_2_compressed_ssim = SSIM_MSE::ssim_mse(*this->image2, *this->image2_compressed,
                                                                    initial_x, initial_y, variable_x, variable_y,
                                                                    blocksize);
...
#endif //DANDERE2X_CPP_SSIM_GRADER_H
